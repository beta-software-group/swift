...
<html>
  ...
  <script>
      $(document).ready(function(){
        ...
        $(".itemsList").on("click", "input[type=checkbox]", function () {
        ...
        $("#btnAddTask").button().click(function(){
            $("#task-dialog").dialog({width:550, resizable:false, modal:true,
                buttons:{
                        ...
                        ("<li><input type ='checkbox'>" + taskName + " </li>")
                           ...
                           $("#projects " + title).append(
                             ('<li class = "ui-sortable-handle">' +
                              '<input type = "checkbox">' +
                              '<span class = "display">' + taskName + '</span>' +
    ...
    <body>
      <div id= "Container" class="black-border">
        ...
        <div id= "projects">
          ...
          <ol id= "personal", class = "itemsList">
            <li><input type = "checkbox">
              <span class = "display">Software Engineering Lecture</span>
              <input type = "text" class = "edit" style = "display:none">
            </li>
            <li><input type = "checkbox">
              <span class = "display">Present Task Scheduler</span>
              <input type = "text" class = "edit" style = "display:none">
            </li>
            <li><input type = "checkbox">
              <span class = "display">Eat Dinner</span>
              <input type = "text" class = "edit" style = "display:none">
            </li>
          </ol>
          <ol id= "work", class = "itemsList">
            <li><input type= "checkbox">
              <span class = "display">Study for Exam</span>
              <input type = "text" class = "edit" style = "display:none">
            </li>
            <li><input type = "checkbox">
              <span class = "display">Finish Homework</span>
              <input type = "text" class = "edit" style = "display:none">
            </li>
            <li><input type = "checkbox">
              <span class = "display">Learn more javaScript</span>
              <input type = "text" class = "edit" style = "display:none">
            </li>
          </ol>
          <ol id= "eventually", class = "itemsList">
            <li><input type= "checkbox">
              <span class = "display">Change checkbox action to strikethrough</span>
              <input type = "text" class = "edit" style = "display:none">
            </li>
            <li><input type = "checkbox">
              <span class = "display">Aggregate all three days into a tab-system</span>
              <input type = "text" class = "edit" style = "display:none">
            </li>
            <li><input type = "checkbox">
              <span class = "display">Add times</span>
              <input type = "text" class = "edit" style = "display:none"></li>
            <li><input type = "checkbox">
              <span class = "display">Integrate with current Swift application</span>
              <input type = "text" class = "edit" style = "display:none">
            </li>
          </ol>
        </div>
